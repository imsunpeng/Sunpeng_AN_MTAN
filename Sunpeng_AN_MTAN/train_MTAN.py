...
from dataloaders.kidney import (kidney, CenterCrop, RandomCrop,
...
parser.add_argument('--root_path', type=str,
                    default='../data/kits21_kidney_data_h5', help='Name of Experiment')##### Change dataset
parser.add_argument('--exp', type=str,
                    default='kits-kidney0_MTAN_hard', help='experiment_name')#### Change exp name
parser.add_argument('--model', type=str,
                    default='AN', help='model_name')
parser.add_argument('--max_iterations', type=int,
                    default=500000, help='maximum epoch number to train')
parser.add_argument('--batch_size', type=int, default=8,
                    help='batch_size per gpu')
parser.add_argument('--deterministic', type=int,  default=16,
...
parser.add_argument('--clean_labeled_num', type=int, default=240,##### Accordingly change HQ setting
                    help='labeled data')
parser.add_argument('--total_sample', type=int, default=540,
                    help='total samples')
# costs
...
def train(args, snapshot_path):
    ...
    db_train = kidney(base_dir=train_data_path,
                         split='train',
                         num=540,
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            try:
                ...
                weak_supervised_loss = supervised_loss
            ...
            # a = loss.item()
            # train_loss_history.append(a)
            # plt.plot(train_loss_history, color='red')
            # plt.title('Train_loss')
            # plt.ylabel('loss')
            # plt.xlabel('Epoch')
            # plt.savefig("../model/tumor-loss.png")
